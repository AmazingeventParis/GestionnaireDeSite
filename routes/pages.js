...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box}
    body{margin:0;padding:0;font-family:"Raleway",sans-serif;color:#333;line-height:1.6;background:${config.colors?.bgAlt || '#f8eaff'};overflow-x:hidden;-webkit-font-smoothing:antialiased}
