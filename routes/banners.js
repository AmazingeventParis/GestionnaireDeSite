...
function buildBannerHtml(banner) {
  ...
  const css = `
.snb-promo-banner{width:100%;z-index:998;position:relative;background:${bg};color:${color};font-family:'Raleway',Arial,sans-serif;margin-top:-20px;margin-bottom:20px;}
